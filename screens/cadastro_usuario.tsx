...
import { ImageBackground, Text, View, Image, TouchableOpacity, Alert, TextInput  } from 'react-native';
...
export default function Cadastro_usuarios()
{
    ...
    return(
        ...
        <StatusBar /> 
                        ...
                        <View>
                           ...
                           <View style={Globalstyles.user_register_item}>
                            ...
                            <View style={Globalstyles.user_register_item}>
                                ...
                                <TextInput style={Globalstyles.user_register_input} value={Adress} onChangeText={setAdress}></TextInput>
                            </View>
                ...
                <TouchableOpacity style={Globalstyles.form_button} ><Text style={{textAlign: 'center', fontWeight: '600', justifyContent: 'center', alignItems: 'center', fontSize: 20, color: 'white'}}>Cadastrar</Text></TouchableOpacity>
